 ...
 * "Advanced server settings". IPTV credentials remain user-configurable; the
 * IPTV Base URL is pre-filled (editable) to match the Flutter product default.
 */
...
/** Default IPTV provider base URL (pre-filled, editable in Settings). */
export const DEFAULT_IPTV_BASE_URL = 'http://xc.nv2.xyz';
