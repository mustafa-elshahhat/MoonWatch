/// Canonical Dart payload models for WatchParty SignalR protocol.
/// This IS shared/protocol/payloads/payloads.dart — the client's
/// client/lib/core/protocol/payloads.dart must mirror this file exactly.
...
class PlaybackPausePayload {
  ...
  const PlaybackPausePayload(
      {required this.positionMs, required this.serverTimestampMs, this.seqNo = 0});
